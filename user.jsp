...
<!--         <div class="header_section">
  ...
  <tr>
    ...
    <td width="14%"><input name="name" placeholder="XYZ" type="text" class="style2"></td>
    <td width="36%">&nbsp;</td>
  </tr>
  <tr>
    <td height="59">&nbsp;</td>
  ...
  <tr>
    <td height="54">&nbsp;</td>
    <td><div align="center">
      <input class="btn-success ringcon" name="Submit" type="submit"  value="Submit">
    </div></td>
    <td><input class="btn-danger ringcon" name="Clear" type="reset"  value="Clear"></td>
    <td>&nbsp;</td>
  </tr>
</table>
</form>   
