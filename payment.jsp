                        ...
                        <div class="col-sm-12">
                            <div class="custom_menu">
                                <ul>
                                    ...
                                    <li><a href="payment.jsp" style="color: yellow">Payment</a></li>
...
<!--                                <div class="dropdown-menu ">
   ...
   <table width="1250">
       ...
       <td colspan="2"><div align="center"><span class="style1 style6" style="font-size: large"><strong> Payment Details </strong></span></div></td>
       <td width="31%">&nbsp;</td>
     </tr>
     <tr>
       <td height="50">&nbsp;</td>
    ...
    <tr>
       ...
       <td><input name="cno" type="text" class="style8"placeholder="004400xxxx9988"></td>
       <td></td>
     </tr>
     <tr>
       <td height="50"></td>
       <td><div align="center"><span class="style8">CCv : </span></div></td>
       <td><input name="ccv" type="password" class="style8"placeholder="***"></td>
       <td></td>
     </tr>
     <tr>
       <td height="50"></td>
       <td><div align="center"><span class="style8">Bank Name : </span></div></td>
       <td><input name="bn" type="text" class="style8"placeholder="xyz bank"></td>
       <td></td>
     </tr>
     <tr>
       <td height="50">&nbsp;</td>
       <td><div align="center">
           <input name="Submit" type="submit" class="btn-success row4" value="Submit">
       </div></td>
       <td><input name="Clear" type="reset" class="btn-danger row4" value="Clear"></td>
       <td>&nbsp;</td>
     </tr>
      </table>
 </form>        
