                  ...
                  <div class="col-sm-12">
                     <div class="custom_menu">
                        <ul>
                         ...
                         <li><a href="user_view_cart1.jsp">View Cart</a></li>
               ...
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     <!--<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>-->
                            ...
                            <a href="user_view_pro.jsp"style="color: yellow">View Product</a>
                            <a href="user_view_cart1.jsp">View Cart</a>
...
<!--                     <div class="lang_box ">
      ...
      <!-- banner bg main end -->
            ...
            <form id="form"  name="form" method="post" action="">
					<table width="911">
  <tr>
      <td height="45" colspan="4"><div align="center" class="style1"><b>PRODUCT: </b></div></td>
    </tr>
  <tr>
    <td width="242" height="52">&nbsp;</td>
  <td width="204" align="center"><span class="style2" ><b>Product Type : </b></span></td>
    <td width="325" align="center"><input name="name" type="text" class="style2" /></td>
    <td width="120" align="center">&nbsp;</td>
  </tr>
  <tr>
    <td height="40" colspan="4"><div align="center">
            <input name="Submit" class="btn-warning" type="submit" value="Search" />
    </div></td>
    </tr>
</table>
            ...
            <table class="siddiq" width="30%"  align="center">
                <tr><td></td>
                    <td><div width="250px" >
            ...
            <table class="asar" width="1250">
                <tr>
                    <td class="td" align="center">
                        <input name="Submit" type="submit" class="btn-info row4" value="AddCart">
                    </td>
                </tr>
            </table>>
        </form>
