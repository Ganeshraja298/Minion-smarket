                        ...
                        <div class="col-sm-12">
                            <div class="custom_menu">
                                <ul>
                                    ...
                                    <li><a href="user_view_cart1.jsp"  style="color:yellow" >View Cart</a></li>
                ...
                <div class="container">
                    <div class="containt_main">
                        <div id="mySidenav" class="sidenav">
                            ...
                            <a href="user_view_cart1.jsp"  style="color:yellow" >View Cart</a>
...
<!--                            <div class="lang_box ">
        ...
        <form action="" method="post" name="form1" id="form1" >
            ...
            <div class="bhc" style="font-size:larger;"><strong>    Cart Details</strong></div>
            ...
            <table width="1250">
                <tr>
                    <td><div align="center">
                            <input name="Submit" type="submit" class="btn-primary row4" value="Submit">
                        </div></td>
                </tr>
            </table>
