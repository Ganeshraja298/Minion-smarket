                     ...
                     <div class="custom_menu">
                        <ul>
                           <li><a href="user_home.jsp">Home</a></li>
                            <li><a href="m_login.jsp"style="color: yellow">Membership Login</a></li>
...
<!--                     <div class="lang_box ">
  ...
  <tr>
    ...
    <td width="14%"><input name="name" type="text" placeholder="0000" class="style2"></td>
    <td width="36%">&nbsp;</td>
  </tr>
  <tr>
    <td height="59">&nbsp;</td>
    <td><div align="center" class="style2"><h2>Password :</h2> </div></td>
    <td><input name="pass" type="password" placeholder="****" class="style2"></td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td height="54">&nbsp;</td>
    <td><div align="center">
      <input name="Submit" type="submit" class="btn-success ringcon" value="Submit">
    </div></td>
    <td><input name="Clear" type="reset" class="btn-danger ringcon" value="Clear"></td>
    <td>&nbsp;</td>
  </tr>
</table>
</form>   
