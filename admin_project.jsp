                        ...
                        <ul>
                           <li><a href="admin_home.jsp">Home</a></li>
                            <li><a href="admin_add_pro.jsp">Add Product</a></li>
                             <li><a href="admin_project.jsp"style="color: yellow">View Product</a></li>
            ...
            <div class="container">
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     <a href="admin_project.jsp"style="color: yellow">View Product</a>
...
<!--                     <div class="lang_box ">
      ...
      <form action="" method="post" name="form1" id="form1" >
                        ...
                        <table width="90%" border="0" align="center">
                             <tr>
                                 <td height="53" colspan="9"><div align="center" class="style1 style3">  <h1 style="color:#e6b800;"> View Product: </h1></div></td></h1>
                            </tr>
                             <tr>
                              ...
                              <td width="55"><h4 align="center" class="style8 style2">Product Type </h4></td>
                             <td width="91"><h4 align="center" class="style8 style2">Model </h4></td>
                           
                            
                              <td width="91"><h4 align="center" class="style8 style2">Price</h4></td>
                              <td width="91"><h4 align="center" class="style8 style2">Quantity</h4></td>
                              <td width="91"><h4 align="center" class="style8 style2">Image</h4></td>
